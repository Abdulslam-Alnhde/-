...
export function ExamReviewForm() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto mt-6 space-y-6 pb-12">
      ...
      {overExamCap && (
        <div
          className="rounded-xl border border-amber-300 bg-amber-50 px-4 py-3 text-sm font-bold text-amber-950 dark:bg-amber-950/30 dark:text-amber-100 flex flex-wrap items-center justify-between gap-4"
          role="status"
        >
          <div>
          ...
          <Button
            ...
            variant="outline"
            size="sm"
            className="h-8 bg-amber-200 border-amber-400 hover:bg-amber-300 text-amber-950 font-black rounded-lg gap-2"
            onClick={() => {
          ...
          return (
            <div key={qIndex} className="bg-card border-2 rounded-2xl p-5 md:p-6 shadow-sm transition-all hover:shadow-md relative overflow-hidden group">
              ...
              <div className="border-b pb-4 mb-4 relative z-10">
                ...
                <div className="bg-muted/30 p-3 rounded-xl border border-dashed border-zinc-200 dark:border-zinc-800 text-sm font-bold leading-relaxed italic text-zinc-600 dark:text-zinc-300 relative">
                  <span className="absolute -top-3 right-4 px-2 py-0.5 bg-white dark:bg-zinc-900 border text-[9px] font-black uppercase tracking-widest text-zinc-400">
                    الإجابة النموذجية
                  </span>
                  "{q.modelAnswer}"
                </div>
              ...
              <div className="space-y-4 relative z-10">
                ...
                {isObjective ? (
                  <div className="rounded-2xl border border-emerald-200/70 bg-emerald-50/60 px-4 py-5 text-right text-sm font-bold text-emerald-900 dark:border-emerald-900/40 dark:bg-emerald-950/20 dark:text-emerald-100">
                      ...
                      {q.keyPoints.map((point, pIndex) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="absolute -right-3 -top-3 bg-rose-500 text-white p-2 rounded-xl opacity-0 group-hover/point:opacity-100 transition-all flex items-center justify-center hover:scale-110 shadow-lg shadow-rose-500/30 ring-4 ring-white"
                          >
