    ...
    <div className="bg-card w-full max-w-4xl mx-auto mt-4 space-y-6">
      ...
      <div className="text-center mb-4 space-y-2">
        ...
        <p className="text-muted-foreground text-xs font-bold opacity-70 max-w-2xl mx-auto leading-relaxed">
          ارفع PDF أو صوراً لورقة الاختبار. يمكن معاينة كل ملف قبل التشغيل. الملازم المرجعية مدعومة بصيغ PDF والصور وملفات TXT.
        </p>
      </div>
        ...
        <div className="rounded-3xl border bg-card p-6 shadow-sm flex flex-col hover:shadow-lg transition-all duration-300 dark:border-zinc-800 group">
          <div className="w-full text-center border-b border-muted pb-4 mb-5">
            ...
            <p className="text-[10px] font-black text-muted-foreground mt-1 uppercase tracking-wider opacity-60">
              PDF أو صور — رفع عالي الجودة مع معاينة قبل الاستخراج
            </p>
          </div>
